...
1. Validate the Cloudflare production build and live website after the PPMP v2 / Sandminni brand finalization, including Home, Quick Start, Reference, and copy interactions.
...
- Apply the **Sandminni** product brand consistently across the non-normative public presentation layer without blurring the PPMP protocol / PPM implementation boundary.
