...
- failure semantics
- continuity integration semantics if parallel continuity becomes part of Core 0.2
...
If Core 0.2 includes Continuity Lineage, the VCS and non-VCS conformance cases are mandatory before `v1.0.0`.
...
- any Core 0.2 lineage conformance if applicable
...
## Recommended v1.0.0 evidence threshold

The following is the current recommended threshold, subject to refinement through Core 0.2 work:
...
| Upgrade evidence | >= 1 real compatible upgrade |
