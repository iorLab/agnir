...
const groups = [
  { kind: 'spec', label: 'Protocol', description: 'Normative iorMemory protocol semantics and migration rules.', files: ['CORE.md','MANIFEST.md','CLASSIFICATION.md','PERSISTENCE.md','BOOTSTRAP.md','VERSIONING.md','MIGRATION.md'] },
  { kind: 'profiles', label: 'Profiles', description: 'Composable domain extensions layered on iorMemory Core.', files: ['software.md','product.md','content.md','research.md','planning.md','generic.md'] },
  { kind: 'implementations', label: 'Implementation', description: 'Reference implementation behavior kept distinct from protocol requirements.', files: ['PERSISTENT_PROJECT_MEMORY.md'] },
  ...
  { kind: 'templates', label: 'Templates', description: 'Copy-ready reference serialization and ChatGPT setup.', files: ['PROJECT_INSTRUCTIONS.md','project-memory.yaml','PROJECT_STATE.md','NEXT_STEPS.md','DECISIONS.md','SESSION.md'] }
];
