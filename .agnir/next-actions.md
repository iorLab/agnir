...
2. **Observe the accepted locator-only handoff in the next genuine fresh ChatGPT Project initialization.** The packaging contract is accepted and conformance-protected. Treat a future verbose handoff as a regression; do not solve it by duplicating Agnir operational semantics back into Project Instructions.
