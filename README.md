...
`latest stable` means an actually published non-prerelease tag/Release, never a moving `main`, temporary release branch, RC, or untagged commit. The latest published stable package is `v1.0.2`, released from exact authoritative revision `b5626394ec40a5cb7a28c01892acde07cc0adc8e`. Core `1.0` and `repository-filesystem/1.0` remain unchanged; stable-upgrade resolution now selects `v1.0.2`.
...
- published `v1.0.2`: same Core `1.0` + `repository-filesystem/1.0`, with locator-only ChatGPT Project bootstrap hardening only.
...
**Latest published stable package: `v1.0.2`** — Core `1.0` + `repository-filesystem/1.0`, exact stable source `b5626394ec40a5cb7a28c01892acde07cc0adc8e`.

**Published patch: `v1.0.2`** — locator-only ChatGPT Project bootstrap hardening only; Core `1.0` and `repository-filesystem/1.0` remain unchanged.

**Previous patch: `v1.0.1`** — activation/packaging reliability hardening only; immutable at `f56d25b22997c259c660651e7357334b063093e1`.
